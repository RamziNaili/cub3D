...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/17 19:33:52 by ranaili           #+#    #+#             */
/*   Updated: 2021/02/25 16:02:15 by ranaili          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

void	ft_convert_to_hexadecimal(unsigned int nbr)
{
	int			tab[12];
	int			i;
	char		*base;
...
int		ft_hexadecimal(unsigned int nbr, t_flags stru, int printed_car)
{
	int		sign;
